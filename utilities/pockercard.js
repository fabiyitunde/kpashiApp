    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        this.setState({
          ...
          move: {},
          init: {
            top: this.state.init.top + gestureState.dy,
            left: this.state.init.left + gestureState.dx
          }
        });
      }
    });
    ...
    return (
      ...
      >
        <View style={styles.leftTop}>
          <Text style={[styles.type, { color: this.props.color }]}>
            {this.props.type}
          </Text>
          <Text style={[styles.order, { color: this.props.color }]}>
            {this.props.order}
          </Text>
        </View>
        ...
        <View style={styles.center}>
          <Text style={[styles.centerLogo, { color: this.props.color }]}>
            {this.props.type}
          </Text>
        </View>
      </View>
